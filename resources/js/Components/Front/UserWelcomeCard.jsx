    ...
    return (
        <BaseCard>
            <div className="welcome-copy d-flex flex-column gap-3">
                ...
                {site?.logo ?? (
                    <img src={site?.logo} alt={`${site.name ?? userName}`} className="w-75 img-fluid mx-auto" />
                )}
                <p>{site.content ? site.content : 'Accede o crea tu cuenta para guardar favoritos y recibir promociones.'}</p>
